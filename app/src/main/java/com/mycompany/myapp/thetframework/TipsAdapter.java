...
public class TipsAdapter extends RecyclerView.Adapter<TipsAdapter.MyViewHolder> {
    private List<TipItem> infoLists;
    int i;
    static int je;
    TipsAdapter.OnRecycleViewItemClicker Listener;
...
//            authog = (TextView) view.findViewById(R.id.authog);
    ...
    public TipsAdapter(List<TipItem>sanfoLists, TipsAdapter.OnRecycleViewItemClicker recycler){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.tips, parent, false);
        return new MyViewHolder(itemView);
    }

    public void setInfoLists(List<TipItem> infoLists) {
        this.infoLists = infoLists;
        this.notifyDataSetChanged();
    }

    public List<TipItem> getInfoLists() {
        return infoLists;
    }

    @Override
    public void onBindViewHolder(TipsAdapter.MyViewHolder holder, final int position) {
        holder.setIsRecyclable(false);
        TipItem ques = infoLists.get(position);
        je = position;
...
//        }
    ...
    public void setOnItemclickedListener(TipsAdapter.OnRecycleViewItemClicker listener){
