 ...
 */
public class LoadAnswerun extends android.support.v4.content.AsyncTaskLoader<List<question>> {
    ...
    public LoadAnswerun(Context context) {
        super(context);
    ...
    public List<question> loadInBackground() {
        ...
        dreaference.orderByKey().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                qstring = new ArrayList<String>(objectHashMap.keySet());
//                 anquestions = new ArrayList<question>();
//                List<String> anstring = new ArrayList<String>();
                for (int i = 0; i < questions.size(); i++) {
                    if (!questions.get(i).isAnswered()) {
                        questions.get(i).setQueid(qstring.get(i));
